...
# n_course = 1 IEA514 R Programming E; n_lesson = 15
# n_course = 2 IEA514 Getting and Cleaning Data; n_lesson = 4
# n_course = 3 IEA514 Exploratory Data Analysis; n_lesson = 9
